# Investigation Skills Implementation Plan — Phase 3: triage-rule-hits

**Goal:** Create the triage-rule-hits skill that automates rule hit classification (TP/FP/novel/uncertain) to surface what needs human attention.

**Architecture:** A SKILL.md methodology document following existing plugin conventions. Defines rule hit sampling via data-analyst, per-hit classification schema, aggregate output with rule_health assessment, and escalation path to B-I-N-D-Ts. No SQL, no code.
...
<!-- START_TASK_1 -->
### Task 1: Create triage-rule-hits skill directory and SKILL.md scaffold

**Verifies:** None (infrastructure)

**Files:**
- Create: `plugins/skywatch-investigations/skills/triage-rule-hits/SKILL.md`

**Step 1: Create the skill file with frontmatter and introduction**

Create `plugins/skywatch-investigations/skills/triage-rule-hits/SKILL.md` with:
...
Run: `ls -la plugins/skywatch-investigations/skills/triage-rule-hits/SKILL.md`
Expected: File exists.

**Step 3: Commit**

```bash
git add plugins/skywatch-investigations/skills/triage-rule-hits/SKILL.md
git commit -m "feat: scaffold triage-rule-hits skill with frontmatter"
```
<!-- END_TASK_1 -->
...
**Verifies:** investigation-skills.AC3.1 (sampling methodology), investigation-skills.AC3.5 (no-data handling)

**Files:**
- Modify: `plugins/skywatch-investigations/skills/triage-rule-hits/SKILL.md`
...
Run: `wc -l plugins/skywatch-investigations/skills/triage-rule-hits/SKILL.md`
Expected: Approximately 55-70 lines.

**Step 3: Commit**

```bash
git add plugins/skywatch-investigations/skills/triage-rule-hits/SKILL.md
git commit -m "feat: add data collection section to triage-rule-hits skill"
```
<!-- END_TASK_2 -->
...
**Verifies:** investigation-skills.AC3.1 (per-hit TP/FP/novel/uncertain classification), investigation-skills.AC3.2 (aggregate counts, FP examples, novel patterns with suggested actions), investigation-skills.AC3.3 (rule_health assessment), investigation-skills.AC3.4 (novel patterns with description and examples), investigation-skills.AC3.5 (no-data summary in output)
...
Run: `wc -l plugins/skywatch-investigations/skills/triage-rule-hits/SKILL.md`
Expected: Approximately 150-190 lines total.

**Step 3: Commit**

```bash
git add plugins/skywatch-investigations/skills/triage-rule-hits/SKILL.md
git commit -m "feat: add classification and output sections to triage-rule-hits skill"
```
<!-- END_TASK_3 -->
