...
When a full report is requested, load the `skywatch-reporting-results` skill and produce a report using the structured assessment as source material:
