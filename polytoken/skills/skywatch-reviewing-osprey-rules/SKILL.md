---
name: skywatch-reviewing-osprey-rules
...
Check rules against the conventions defined in `skywatch-osprey-sml-reference`
(`references/sml-conventions.md`). Load the `skywatch-osprey-sml-reference` skill if
