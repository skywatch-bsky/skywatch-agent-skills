...
Structured checklist used by the `osprey-rule-writer` agent during the review phase
(loaded via `skywatch-reviewing-osprey-rules` skill). Each check has an ID
